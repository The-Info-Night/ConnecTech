...
const navSections: { category: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Catalog",
        icon: <Image src="/catalog.svg" alt="Catalog Icon" width={24} height={24} />,
      ...
      <nav className="mt-4">
        <ul className="flex flex-col gap-2">
          <li key="login-or-account">
            {loading ? (
              <div
                className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-gray-500 dark:text-gray-400 ${
                  open ? "" : "justify-center"
                }`}
              >
          ...
          {navSections.map((section, sectionIndex) => (
            <div key={section.category}>
              {sectionIndex > 0 && <hr className="my-2 border-gray-300 dark:border-gray-700" />}
