...
export default function PitchDeckPage() {
    ...
    return (
      <div className="font-sans min-h-screen" style={{ backgroundColor: "#1A1D21" }}>
        {/* Main content */}
        <main
          className="flex flex-col items-center justify-center min-h-screen py-16 ml-0 md:ml-56 transition-all duration-300"
          style={{
...
>
  ...
  {/* Traction Slide */}
  <div className="mb-12">
    <h3 className="text-3xl font-bold mb-6 text-blue-700 border-b pb-2">Traction & Key Stats</h3>
    {/* Contenu de la branche 'Catalog' intégré ici */}
  ...
  <div className="text-center">
    ...
    <div className="bg-blue-50 p-6 rounded-lg">
      ...
      <p className="text-lg font-semibold">Contact: <span className="text-blue-600">invest@connectech.com</span></p>
    </div>
  </div>
</div>
